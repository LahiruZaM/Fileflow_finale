...
class _StringsReceiveOptionsPageKm extends _StringsReceiveOptionsPageEn {
	...
	@override String get appDirectory => '(ថតឯកសារ FileFlow)';
...
class _StringsWebSharePageKm extends _StringsWebSharePageEn {
	...
	@override String get encryptionHint => 'FileFlow ប្រើវិញ្ញាបនបត្រដែលចុះហត្ថលេខាដោយខ្លួនឯង។ អ្នកត្រូវទទួលយកវានៅក្នុងកម្មវិធី​ browser ។';
...
class _StringsAboutPageKm extends _StringsAboutPageEn {
	...
	// Translations
	@override String get title => 'អំពី FileFlow';
...
class _StringsDonationPageKm extends _StringsDonationPageEn {
	...
	@override String get info => 'FileFlow ជាកម្មវិធីដែលឥតគិតថ្លៃ, បើកបង្ហាញប្រភពកូដជាសាធារណៈ និងមិនមានការបង្ហាញនូវផ្ទាំងពាណិជ្ជកម្មរំខានឡើយ។ ប្រសិនបើអ្នកពេញចិត្តកម្មវិធីនេះ​ និងចង់ជួយពួកយើង, អ្នកអាចចូលរួមលើកស្ទួយការអភិវឌ្ឍន៍កម្មវិធីនេះជាមួយពួកយើងតាមរយៈការឧបត្ថម្ភជាថវិកា។';
...
class _StringsTrayKm extends _StringsTrayEn {
	...
	@override String get close => 'ចាកចេញពីកម្មវិធី FileFlow';
}
...
class _StringsSettingsTabOtherKm extends _StringsSettingsTabOtherEn {
	...
	@override String get support => 'ជួយគាំទ្រ FileFlow';
...
class _StringsDialogsLocalNetworkUnauthorizedKm extends _StringsDialogsLocalNetworkUnauthorizedEn {
	...
	@override String get description => 'FileFlow មិន​អាច​រក​ឃើញ​ឧបករណ៍​ផ្សេង​ទៀត​ដោយ​មិន​មាន​ការ​អនុញ្ញាត​ក្នុង​ការ​ស្កែន​បណ្តាញរួមគ្នា​ទេ។ សូមផ្តល់ការអនុញ្ញាតនេះនៅក្នុងការកំណត់។';
...
class _StringsDialogsSendModeHelpKm extends _StringsDialogsSendModeHelpEn {
	...
	@override String get link => 'អ្នកទទួលដែលមិនបានដំឡើង FileFlow អាចទាញយកឯកសារដែលបានជ្រើសរើសដោយបើកតំណនៅក្នុងកម្មវិធី browser របស់ពួកគេ។';
}
