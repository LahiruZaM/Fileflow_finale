...
class _StringsReceiveOptionsPageHu extends _StringsReceiveOptionsPageEn {
	...
	@override String get appDirectory => '(FileFlow mappa)';
...
class _StringsWebSharePageHu extends _StringsWebSharePageEn {
	...
	@override String get encryptionHint => 'A FileFlow a saját aláírt tanúsítványt használja. A böngészőben kell elfogadnod.';
...
class _StringsAboutPageHu extends _StringsAboutPageEn {
	...
	// Translations
	@override String get title => 'A FileFlow';
...
class _StringsDonationPageHu extends _StringsDonationPageEn {
	...
	@override String get info => 'A FileFlow ingyenes, nyílt forráskódú és hirdetések nélküli. Ha megtetszett az alkalmazás, adományával támogathatja a fejlesztést.';
...
class _StringsSettingsTabGeneralHu extends _StringsSettingsTabGeneralEn {
	...
	@override String get showInContextMenu => 'A FileFlow megjelenítése a helyi menüben';
...
class _StringsSettingsTabOtherHu extends _StringsSettingsTabOtherEn {
	...
	@override String get support => 'FileFlow támogatás';
...
class _StringsDialogsLocalNetworkUnauthorizedHu extends _StringsDialogsLocalNetworkUnauthorizedEn {
	...
	@override String get description => 'A FileFlow nem találhat más eszközöket a helyi hálózat vizsgálatára vonatkozó engedély nélkül. Adja meg ezt az engedélyt a beállításokban.';
...
class _StringsDialogsSendModeHelpHu extends _StringsDialogsSendModeHelpEn {
	...
	@override String get link => 'Azok a címzettek, akiknél nincs telepítve a FileFlow, letölthetik a kiválasztott fájlokat a hivatkozás megnyitásával a böngészőjükben.';
}
