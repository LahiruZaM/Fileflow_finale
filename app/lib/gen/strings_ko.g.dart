...
class _StringsReceiveOptionsPageKo extends _StringsReceiveOptionsPageEn {
	...
	@override String get appDirectory => '(FileFlow 폴더)';
...
class _StringsWebSharePageKo extends _StringsWebSharePageEn {
	...
	@override String get encryptionHint => 'FileFlow는 자체 서명된 인증서를 사용합니다. 브라우저에서 수락해야 합니다.';
...
class _StringsAboutPageKo extends _StringsAboutPageEn {
	...
	// Translations
	@override String get title => 'FileFlow에 대해';
	@override List<String> get description => [
		'FileFlow는 인터넷 연결이 필요 없이 로컬 네트워크를 통해 주변 기기와 파일 및 메시지를 안전하게 공유할 수 있는 무료 오픈소스 앱입니다.',
...
class _StringsDonationPageKo extends _StringsDonationPageEn {
	...
	@override String get info => 'FileFlow는 광고 없이 무료이며 오픈소스입니다. 앱을 좋아하신다면 개발을 후원하는 기부를 해주세요.';
...
class _StringsTrayKo extends _StringsTrayEn {
	...
	@override String get close => 'FileFlow 종료';
}
...
class _StringsSettingsTabGeneralKo extends _StringsSettingsTabGeneralEn {
	...
	@override String get showInContextMenu => '컨텍스트 메뉴에 FileFlow 표시';
...
class _StringsSettingsTabOtherKo extends _StringsSettingsTabOtherEn {
	...
	@override String get support => 'FileFlow 지원';
...
class _StringsDialogsLocalNetworkUnauthorizedKo extends _StringsDialogsLocalNetworkUnauthorizedEn {
	...
	@override String get description => '로컬 네트워크를 스캔할 권한이 없어 FileFlow가 다른 기기를 찾을 수 없습니다. 설정에서 권한을 부여해주세요.';
...
class _StringsDialogsSendModeHelpKo extends _StringsDialogsSendModeHelpEn {
	...
	@override String get link => 'FileFlow를 설치하지 않은 수신자는 브라우저에서 링크를 열어 선택한 파일을 다운로드할 수 있습니다.';
}
