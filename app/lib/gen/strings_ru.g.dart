...
class _StringsReceiveOptionsPageRu extends _StringsReceiveOptionsPageEn {
	...
	@override String get appDirectory => '(Папка FileFlow)';
...
class _StringsWebSharePageRu extends _StringsWebSharePageEn {
	...
	@override String get encryptionHint => 'FileFlow использует самоподписанный сертификат. Вам необходимо принять его в браузере.';
...
class _StringsAboutPageRu extends _StringsAboutPageEn {
	...
	// Translations
	@override String get title => 'О FileFlow';
...
class _StringsDonationPageRu extends _StringsDonationPageEn {
	...
	@override String get info => 'FileFlow — это бесплатное приложение с открытым исходным кодом и без рекламы. Если оно вам нравится, вы можете поддержать его разработку пожертвованием.';
...
class _StringsTrayRu extends _StringsTrayEn {
	...
	@override String get close => 'Выйти из FileFlow';
...
class _StringsSettingsTabGeneralRu extends _StringsSettingsTabGeneralEn {
	...
	@override String get showInContextMenu => 'Отображать FileFlow в контекстном меню';
...
class _StringsSettingsTabOtherRu extends _StringsSettingsTabOtherEn {
	...
	@override String get support => 'Поддержать FileFlow';
...
class _StringsDialogsLocalNetworkUnauthorizedRu extends _StringsDialogsLocalNetworkUnauthorizedEn {
	...
	@override String get description => 'FileFlow не может найти другие устройства без разрешения на сканирование локальной сети. Пожалуйста, предоставьте это разрешение в настройках.';
...
class _StringsDialogsSendModeHelpRu extends _StringsDialogsSendModeHelpEn {
	...
	@override String get link => 'Получатели, у которых не установлен FileFlow, могут загрузить выбранные файлы, открыв ссылку в своем браузере.';
}
