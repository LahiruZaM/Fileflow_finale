...
class _StringsReceiveOptionsPageHe extends _StringsReceiveOptionsPageEn {
	...
	@override String get appDirectory => '(תיקיית FileFlow)';
...
class _StringsWebSharePageHe extends _StringsWebSharePageEn {
	...
	@override String get encryptionHint => 'FileFlow משתמש בתעודה עצמית. עליך לאשר אותה בדפדפן.';
...
class _StringsAboutPageHe extends _StringsAboutPageEn {
	...
	// Translations
	@override String get title => 'אודות FileFlow';
...
class _StringsDonationPageHe extends _StringsDonationPageEn {
	...
	@override String get info => 'אפליקציית FileFlow היא חינמית, קוד פתוח וללא פרסומות. אם אתה אוהב את האפליקציה, אתה יכול לתמוך בפיתוח באמצעות תרומה.';
...
class _StringsTrayHe extends _StringsTrayEn {
	...
	@override String get close => 'צא מ-FileFlow';
...
class _StringsSettingsTabGeneralHe extends _StringsSettingsTabGeneralEn {
	...
	@override String get showInContextMenu => 'הצג את FileFlow בתפריט ההקשר';
...
class _StringsSettingsTabOtherHe extends _StringsSettingsTabOtherEn {
	...
	@override String get support => 'תמיכה ב-FileFlow';
...
class _StringsDialogsLocalNetworkUnauthorizedHe extends _StringsDialogsLocalNetworkUnauthorizedEn {
	...
	@override String get description => 'ל־FileFlow אין אפשרות למצוא מכשירים אחרים ללא הרשאה לסריקת הרשת המקומית. אנא הענק את ההרשאה הזו בהגדרות.';
...
class _StringsDialogsSendModeHelpHe extends _StringsDialogsSendModeHelpEn {
	...
	@override String get link => 'מקבלים ש-FileFlow לא מותקן אצלם יוכלו להוריד את הקבצים שנבחרו על ידי פתיחת הקישור בדפדפן שלהם.';
}
