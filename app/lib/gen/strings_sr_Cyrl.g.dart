...
class _StringsWebSharePageSrCyrl extends _StringsWebSharePageEn {
	...
	@override String get encryptionHint => 'FileFlow користи сертификате који су self-signed. Морате да прихватите то у browseru.';
...
class _StringsAboutPageSrCyrl extends _StringsAboutPageEn {
	...
	// Translations
	@override String get title => 'О FileFlow-у';
...
class _StringsDonationPageSrCyrl extends _StringsDonationPageEn {
	...
	@override String get info => 'FileFlow је слободна, апликација отвореног кода без реклама. Ако Вам се допада, можете подржати развој путем донације.';
...
class _StringsSettingsTabGeneralSrCyrl extends _StringsSettingsTabGeneralEn {
	...
	@override String get showInContextMenu => 'Прикажи FileFlow у контекст менију';
...
class _StringsSettingsTabOtherSrCyrl extends _StringsSettingsTabOtherEn {
	...
	@override String get support => 'Подржи FileFlow';
...
class _StringsDialogsLocalNetworkUnauthorizedSrCyrl extends _StringsDialogsLocalNetworkUnauthorizedEn {
	...
	@override String get description => 'FileFlow не може да нађе друге уређаје без дозволе да скенира локалну мрежу. Молим додајте ову дозволу у Подешавања.';
...
class _StringsDialogsSendModeHelpSrCyrl extends _StringsDialogsSendModeHelpEn {
	...
	@override String get link => 'Примаоци који немају FileFlow инсталиран, могу да преузму селектоване фајлове преко Линка у browseru.';
}
