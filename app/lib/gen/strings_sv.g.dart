...
class _StringsReceiveOptionsPageSv extends _StringsReceiveOptionsPageEn {
	...
	@override String get appDirectory => '(FileFlow-mappen)';
...
class _StringsWebSharePageSv extends _StringsWebSharePageEn {
	...
	@override String get encryptionHint => 'FileFlow använder ett självsignerat certifikat. Du behöver acceptera det i webbläsaren.';
...
class _StringsTraySv extends _StringsTrayEn {
	...
	@override String get close => 'Avsluta FileFlow';
}
...
class _StringsDialogsLocalNetworkUnauthorizedSv extends _StringsDialogsLocalNetworkUnauthorizedEn {
	...
	@override String get description => 'FileFlow kan inte hitta andra enheter utan att ha behörighet att skanna det lokala nätverket. Bevilja denna behörighet i inställningarna.';
...
class _StringsDialogsSendModeHelpSv extends _StringsDialogsSendModeHelpEn {
	...
	@override String get link => 'Mottagare som inte har FileFlow installerat kan ladda ner de valda filerna genom att öppna länken i deras webbläsare.';
}
