...
class _StringsWebSharePageFilPh extends _StringsWebSharePageEn {
	...
	@override String get encryptionHint => 'Ang FileFlow ay gumagamit ng self-signed certificate. Kailangan mo itong i-accept sa browser.';
...
class _StringsAboutPageFilPh extends _StringsAboutPageEn {
	...
	// Translations
	@override String get title => 'Tungkol sa FileFlow';
...
class _StringsDonationPageFilPh extends _StringsDonationPageEn {
	...
	@override String get info => 'Ang FileFlow ay libre, open-source, at walang anumang mga ad. Kung iyong nagustuhan ang app, maaari mong suportahan ang development sa pamamagitan ng donasyon.';
...
class _StringsTrayFilPh extends _StringsTrayEn {
	...
	@override String get close => 'Isara ang FileFlow';
...
class _StringsSettingsTabGeneralFilPh extends _StringsSettingsTabGeneralEn {
	...
	@override String get showInContextMenu => 'Ipakita ang FileFlow sa context menu';
...
class _StringsSettingsTabOtherFilPh extends _StringsSettingsTabOtherEn {
	...
	@override String get support => 'Suportahan ang FileFlow';
...
class _StringsDialogsLocalNetworkUnauthorizedFilPh extends _StringsDialogsLocalNetworkUnauthorizedEn {
	...
	@override String get description => 'Hindi makikita ng FileFlow ang ibang devices hangga\'t hindi nabibigyan ng permission para mag-scan sa lokal na network. Mangyaring bigyan ito ng permission sa settings.';
...
class _StringsDialogsSendModeHelpFilPh extends _StringsDialogsSendModeHelpEn {
	...
	@override String get link => 'Ang mga recipient o tatanggap na walang nakainstall na FileFlow ay maaaring mag download nang mga napiling file sa pamamagitan ng pagbukas ng link sa kanilang browser.';
}
