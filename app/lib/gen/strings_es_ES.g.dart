...
class _StringsWebSharePageEsEs extends _StringsWebSharePageEn {
	...
	@override String get encryptionHint => 'FileFlow utiliza un certificado autofirmado. Necesitas aceptarlo en el navegador.';
...
class _StringsDonationPageEsEs extends _StringsDonationPageEn {
	...
	@override String get info => 'FileFlow es libre, open source y no contiene anuncios. Si te gusta la aplicación puedes ayudar al desarrollo con una donación.';
...
class _StringsTrayEsEs extends _StringsTrayEn {
	...
	@override String get close => 'Cerrar FileFlow';
...
class _StringsSettingsTabGeneralEsEs extends _StringsSettingsTabGeneralEn {
	...
	@override String get showInContextMenu => 'Mostrar FileFlow en el menú contextual';
...
class _StringsSettingsTabOtherEsEs extends _StringsSettingsTabOtherEn {
	...
	@override String get support => 'Apoya a FileFlow';
...
class _StringsDialogsLocalNetworkUnauthorizedEsEs extends _StringsDialogsLocalNetworkUnauthorizedEn {
	...
	@override String get description => 'FileFlow no puede encontrar otros dispositivos sin tener permiso para escanear la red local. Por favor, concede este permiso en los ajustes.';
...
class _StringsDialogsSendModeHelpEsEs extends _StringsDialogsSendModeHelpEn {
	...
	@override String get link => 'Los destinatarios que no tengan FileFlow instalado pueden descargar los archivos seleccionados abriendo el enlace en su navegador.';
}
