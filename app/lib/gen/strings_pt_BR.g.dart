...
class _StringsReceiveOptionsPagePtBr extends _StringsReceiveOptionsPageEn {
	...
	@override String get appDirectory => '(pasta FileFlow)';
...
class _StringsWebSharePagePtBr extends _StringsWebSharePageEn {
	...
	@override String get encryptionHint => 'FileFlow utiliza um certificado autoassinado. Você precisa aceitá-lo no navegador.';
...
class _StringsAboutPagePtBr extends _StringsAboutPageEn {
	...
	// Translations
	@override String get title => 'Sobre FileFlow';
...
class _StringsDonationPagePtBr extends _StringsDonationPageEn {
	...
	@override String get info => 'FileFlow é gratuito, de código aberto e sem nenhum anúncio. Se tu curte o app, então considere apoiar o desenvolvimento com uma doação!';
...
class _StringsTrayPtBr extends _StringsTrayEn {
	...
	@override String get close => 'Fechar FileFlow';
...
class _StringsSettingsTabGeneralPtBr extends _StringsSettingsTabGeneralEn {
	...
	@override String get showInContextMenu => 'Mostrar FileFlow no menu de contexto';
...
class _StringsSettingsTabOtherPtBr extends _StringsSettingsTabOtherEn {
	...
	@override String get support => 'Suporte o FileFlow';
...
class _StringsDialogsLocalNetworkUnauthorizedPtBr extends _StringsDialogsLocalNetworkUnauthorizedEn {
	...
	@override String get description => 'O FileFlow não consegue encontrar outros dispositivos sem ter a permissão para escanear a rede local. Por favor, conceda esta permissão nas configurações.';
...
class _StringsDialogsSendModeHelpPtBr extends _StringsDialogsSendModeHelpEn {
	...
	@override String get link => 'Os destinatários que não têm o FileFlow instalado podem baixar os arquivos selecionados abrindo o link fornecido no navegador.';
}
