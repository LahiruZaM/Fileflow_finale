...
class _StringsWebSharePageEn {
	...
	String get encryptionHint => 'FileFlow uses a self-signed certificate. You need to accept it in your browser.';
...
class _StringsDonationPageEn {
	...
	String get info => 'FileFlow is free, open-source and without any ads. If you like the app, you can support the development with a donation.';
...
class _StringsDialogsLocalNetworkUnauthorizedEn {
	...
	String get description => 'FileFlow can\'t find other devices without having the permission to scan the local network. Please grant this permission in the settings.';
...
class _StringsDialogsSendModeHelpEn {
	...
	String get link => 'Recipients who do not have FileFlow installed can download the selected files by opening the link in their browser.';
}
