...
class _StringsWebSharePageUk extends _StringsWebSharePageEn {
	...
	@override String get encryptionHint => 'FileFlow використовує самопідписаний сертифікат. Вам потрібно прийняти його в браузері.';
...
class _StringsAboutPageUk extends _StringsAboutPageEn {
	...
	// Translations
	@override String get title => 'Про FileFlow';
...
class _StringsDonationPageUk extends _StringsDonationPageEn {
	...
	@override String get info => 'FileFlow — це безплатна програма з відкритим вихідним кодом та без реклами. Якщо вона вам подобається, ви можете підтримати її розробку пожертвою.';
...
class _StringsTrayUk extends _StringsTrayEn {
	...
	@override String get close => 'Вийти з FileFlow';
...
class _StringsSettingsTabGeneralUk extends _StringsSettingsTabGeneralEn {
	...
	@override String get showInContextMenu => 'Відображати FileFlow в контекстному меню';
...
class _StringsSettingsTabOtherUk extends _StringsSettingsTabOtherEn {
	...
	@override String get support => 'Підтримати FileFlow';
...
class _StringsDialogsLocalNetworkUnauthorizedUk extends _StringsDialogsLocalNetworkUnauthorizedEn {
	...
	@override String get description => 'FileFlow не може знайти інші пристрої без дозволу на сканування локальної мережі. Будь ласка, надайте цей дозвіл у налаштуваннях.';
...
class _StringsDialogsSendModeHelpUk extends _StringsDialogsSendModeHelpEn {
	...
	@override String get link => 'Отримувачі, у яких не встановлено FileFlow, можуть завантажити вибрані файли, відкривши посилання у своєму браузері.';
}
