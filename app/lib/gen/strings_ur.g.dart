...
class _StringsWebSharePageUr extends _StringsWebSharePageEn {
	...
	@override String get encryptionHint => 'FileFlow براؤزر میں استعمال کرنے کیلئے آپ کوخود سائن کردہ سرٹیفکیٹ قبول کرنا ہوگا۔';
...
class _StringsAboutPageUr extends _StringsAboutPageEn {
	...
	// Translations
	@override String get title => 'کے بارے میں FileFlow';
...
class _StringsDonationPageUr extends _StringsDonationPageEn {
	...
	@override String get info => 'FileFlow مفت، اوپن سورس ہے اور اس میں کوئی اشتہارات نہیں ہیں۔ اگر آپ کو ایپ پسند ہے، تو آپ عطیہ کے ذریعے ترقی کی حمایت کر سکتے ہیں۔';
...
class _StringsTrayUr extends _StringsTrayEn {
	...
	@override String get close => 'چھوڑو FileFlow';
...
class _StringsSettingsTabGeneralUr extends _StringsSettingsTabGeneralEn {
	...
	@override String get showInContextMenu => 'سیاق و سباق کے مینو میں FileFlow دکھائیں';
...
class _StringsSettingsTabOtherUr extends _StringsSettingsTabOtherEn {
	...
	@override String get support => 'FileFlow کی حمایت کریں';
...
class _StringsDialogsLocalNetworkUnauthorizedUr extends _StringsDialogsLocalNetworkUnauthorizedEn {
	...
	@override String get description => 'لوکل نیٹ ورک کا سکین کرنے کی اجازت کے بغیر FileFlow، دیگر ڈیوائسز تلاش نہیں کرسکتا ہے۔ براہ کرم ترتیبات میں اس اجازت کو منظور کریں۔';
...
class _StringsDialogsSendModeHelpUr extends _StringsDialogsSendModeHelpEn {
	...
	@override String get link => 'FileFlow نصب نہیں ہونے والے رسیورز منتخب شدہ فائلز کو لنک اپنے براؤزر میں کھولنے سے ڈاؤن لوڈ کر سکتے ہیں۔';
}
