...
class _StringsWebSharePagePtPt extends _StringsWebSharePageEn {
	...
	@override String get encryptionHint => 'O FileFlow utiliza um certificado assinado automaticamente. Precisa de aceitá-lo no navegador.';
...
class _StringsAboutPagePtPt extends _StringsAboutPageEn {
	...
	// Translations
	@override String get title => 'Acerca do FileFlow';
...
class _StringsDonationPagePtPt extends _StringsDonationPageEn {
	...
	@override String get info => 'O FileFlow é um software gratuito, de código aberto e sem qualquer anúncio. Se gosta da aplicação, então considere apoiar o desenvolvimento com um donativo!';
...
class _StringsTrayPtPt extends _StringsTrayEn {
	...
	@override String get close => 'Fechar o FileFlow';
}
...
class _StringsDialogsLocalNetworkUnauthorizedPtPt extends _StringsDialogsLocalNetworkUnauthorizedEn {
	...
	@override String get description => 'O FileFlow não consegue encontrar outros dispositivos sem ter a permissão para analisar a rede local. Conceda esta permissão nas definições.';
...
class _StringsDialogsSendModeHelpPtPt extends _StringsDialogsSendModeHelpEn {
	...
	@override String get link => 'Os destinatários que não têm o FileFlow instalado podem descarregar os ficheiros selecionados abrindo o link fornecido no navegador.';
}
