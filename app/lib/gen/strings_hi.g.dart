...
class _StringsReceiveOptionsPageHi extends _StringsReceiveOptionsPageEn {
	...
	@override String get appDirectory => '(FileFlow फ़ोल्डर)';
...
class _StringsWebSharePageHi extends _StringsWebSharePageEn {
	...
	@override String get encryptionHint => 'FileFlow एक स्व-हस्ताक्षरित प्रमाणपत्र का उपयोग करता है। आपको इसे अपने ब्राउज़र में स्वीकार करना होगा।';
...
class _StringsAboutPageHi extends _StringsAboutPageEn {
	...
	// Translations
	@override String get title => 'FileFlow के बारे में';
...
class _StringsDonationPageHi extends _StringsDonationPageEn {
	...
	@override String get info => 'FileFlow मुफ्त, ओपन-सोर्स और बिना किसी विज्ञापन के है। यदि आपको ऐप पसंद है, तो आप विकास का समर्थन दान करके कर सकते हैं।';
...
class _StringsTrayHi extends _StringsTrayEn {
	...
	@override String get close => 'FileFlow बंद करें';
}
...
class _StringsSettingsTabGeneralHi extends _StringsSettingsTabGeneralEn {
	...
	@override String get showInContextMenu => 'कॉन्टेक्स्ट मेनू में FileFlow दिखाएं';
...
class _StringsSettingsTabOtherHi extends _StringsSettingsTabOtherEn {
	...
	@override String get support => 'FileFlow का समर्थन करें';
...
class _StringsDialogsLocalNetworkUnauthorizedHi extends _StringsDialogsLocalNetworkUnauthorizedEn {
	...
	@override String get description => 'FileFlow स्थानीय नेटवर्क को स्कैन करने की अनुमति के बिना अन्य डिवाइसों को नहीं ढूंढ सकता। कृपया सेटिंग्स में यह अनुमति दें।';
...
class _StringsDialogsSendModeHelpHi extends _StringsDialogsSendModeHelpEn {
	...
	@override String get link => 'जिन प्राप्तकर्ताओं के पास FileFlow इंस्टॉल नहीं है, वे अपने ब्राउज़र में लिंक खोलकर चयनित फ़ाइलें डाउनलोड कर सकते हैं।';
}
