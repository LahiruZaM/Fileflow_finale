...
class _StringsWebSharePageBn extends _StringsWebSharePageEn {
	...
	@override String get encryptionHint => 'FileFlow একটি স্ব-স্বাক্ষরিত শংসাপত্র ব্যবহার করে। আপনাকে ব্রাউজারে এটি গ্রহণ করতে হবে।';
...
class _StringsAboutPageBn extends _StringsAboutPageEn {
	...
	// Translations
	@override String get title => 'FileFlow সম্পর্কে';
...
class _StringsDonationPageBn extends _StringsDonationPageEn {
	...
	@override String get info => 'FileFlow বিনামূল্যে, ওপেন সোর্স এবং কোনো বিজ্ঞাপন ছাড়াই। আপনি যদি অ্যাপটি পছন্দ করেন তবে আপনি একটি অনুদান দিয়ে বিকাশকে সমর্থন করতে পারেন।';
...
class _StringsTrayBn extends _StringsTrayEn {
	...
	@override String get close => 'FileFlow থেকে প্রস্থান করুন';
}
...
class _StringsDialogsLocalNetworkUnauthorizedBn extends _StringsDialogsLocalNetworkUnauthorizedEn {
	...
	@override String get description => 'স্থানীয় নেটওয়ার্ক স্ক্যান করার অনুমতি ছাড়া FileFlow অন্য ডিভাইস খুঁজে পায় না। অনুগ্রহ করে সেটিংসে এই অনুমতি দিন.';
...
class _StringsDialogsSendModeHelpBn extends _StringsDialogsSendModeHelpEn {
	...
	@override String get link => 'যাদের কাছে FileFlow ইনস্টল নেই তারা তাদের ব্রাউজারে লিঙ্কটি খুলে নির্বাচিত ফাইলগুলি ডাউনলোড করতে পারেন৷';
}
