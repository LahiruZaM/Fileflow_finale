...
class _StringsReceiveOptionsPageEl extends _StringsReceiveOptionsPageEn {
	...
	@override String get appDirectory => '(Φάκελος FileFlow)';
...
class _StringsWebSharePageEl extends _StringsWebSharePageEn {
	...
	@override String get encryptionHint => 'Το FileFlow χρησιμοποιεί αυτο-υπογεγραμμένο πιστοποιητικό. Χρειάζεται να το αποθεχτείτε στον φυλλομετρητή.';
...
class _StringsAboutPageEl extends _StringsAboutPageEn {
	...
	// Translations
	@override String get title => 'Σχετικά με το FileFlow';
...
class _StringsDonationPageEl extends _StringsDonationPageEn {
	...
	@override String get info => 'Το FileFlow είναι δωρεάν, ανοιχτού κώδικα και χωρίς διαφημίσεις. Εάν σας αρέσει η εφαρμογή, μπορείτε να υποστηρίξετε την ανάπτυξή της με μια δωρεά.';
...
class _StringsTrayEl extends _StringsTrayEn {
	...
	@override String get close => 'Έξοδος από το FileFlow';
}
...
class _StringsSettingsTabOtherEl extends _StringsSettingsTabOtherEn {
	...
	@override String get support => 'Υποστηρίξτε το FileFlow';
...
class _StringsDialogsLocalNetworkUnauthorizedEl extends _StringsDialogsLocalNetworkUnauthorizedEn {
	...
	@override String get description => 'FileFlow can\'t find other devices without having the permission to scan the local network. Please grant this permission in the settings.';
...
class _StringsDialogsSendModeHelpEl extends _StringsDialogsSendModeHelpEn {
	...
	@override String get link => 'Οι παραλήπτες που δεν έχουν εγκαταστήσει το FileFlow μπορούν να πραγματοποιήσουν λήψη των επιλεγμένων αρχείων ανοίγοντας τον σύνδεσμο στον φυλλομετρητή τους.';
}
