...
class _StringsWebSharePageCs extends _StringsWebSharePageEn {
	...
	@override String get encryptionHint => 'FileFlow používá self-signed certifikát. Musíte ho přijmout ve vašem prohlížeči.';
...
class _StringsAboutPageCs extends _StringsAboutPageEn {
	...
	// Translations
	@override String get title => 'O aplikaci FileFlow';
...
class _StringsDonationPageCs extends _StringsDonationPageEn {
	...
	@override String get info => 'FileFlow je zdarma, open source a bez reklam. Pokud se vám aplikace líbí, můžete její vývoj podpořit darem.';
...
class _StringsTrayCs extends _StringsTrayEn {
	...
	@override String get close => 'Ukončit FileFlow';
}
...
class _StringsSettingsTabGeneralCs extends _StringsSettingsTabGeneralEn {
	...
	@override String get showInContextMenu => 'Zobrazit FileFlow v kontextové nabídce';
...
class _StringsSettingsTabOtherCs extends _StringsSettingsTabOtherEn {
	...
	@override String get support => 'Podpora FileFlow';
...
class _StringsDialogsLocalNetworkUnauthorizedCs extends _StringsDialogsLocalNetworkUnauthorizedEn {
	...
	@override String get description => 'FileFlow nemůže najít jiná zařízení, aniž by měl oprávnění skenovat místní síť. Udělte prosím toto oprávnění v nastavení.';
...
class _StringsDialogsSendModeHelpCs extends _StringsDialogsSendModeHelpEn {
	...
	@override String get link => 'Příjemci, kteří nemají nainstalovaný FileFlow, si mohou vybrané soubory stáhnout otevřením odkazu ve svém prohlížeči.';
}
