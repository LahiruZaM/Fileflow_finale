...
class _StringsReceiveOptionsPageJa extends _StringsReceiveOptionsPageEn {
	...
	@override String get appDirectory => '(FileFlow フォルダー)';
...
class _StringsWebSharePageJa extends _StringsWebSharePageEn {
	...
	@override String get encryptionHint => 'FileFlowは自己署名証明書を使用しているため、ブラウザーで証明書を許可する必要があります。';
...
class _StringsAboutPageJa extends _StringsAboutPageEn {
	...
	// Translations
	@override String get title => 'FileFlowについて';
	@override List<String> get description => [
		'FileFlowは無料のオープンソースアプリで、インターネットに接続することなく、ローカルネットワーク経由で近くにあるデバイスとファイルやメッセージを安全に共有することができます。',
...
class _StringsDonationPageJa extends _StringsDonationPageEn {
	...
	@override String get info => 'FileFlowは無料かつオープンソースで、広告を一切含みません。もしアプリを気に入っていただけたら、寄付で開発を支援することができます。';
...
class _StringsTrayJa extends _StringsTrayEn {
	...
	@override String get close => 'FileFlowを終了';
...
class _StringsSettingsTabGeneralJa extends _StringsSettingsTabGeneralEn {
	...
	@override String get showInContextMenu => 'コンテキストメニューにFileFlowを表示';
...
class _StringsSettingsTabOtherJa extends _StringsSettingsTabOtherEn {
	...
	@override String get support => 'FileFlowを支援';
...
class _StringsDialogsLocalNetworkUnauthorizedJa extends _StringsDialogsLocalNetworkUnauthorizedEn {
	...
	@override String get description => 'ローカルネットワークをスキャンする権限がないと、FileFlowは他のデバイスを見つけることができません。設定よりこの権限を付与してください。';
...
class _StringsDialogsSendModeHelpJa extends _StringsDialogsSendModeHelpEn {
	...
	@override String get link => 'FileFlowをインストールしていない受信者でも、ブラウザでリンクを開くことで選択したファイルをダウンロードできます。';
}
