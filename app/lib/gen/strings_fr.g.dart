...
class _StringsFr extends Translations {
	...
	@override String get appName => 'FileFlow';
...
class _StringsReceiveOptionsPageFr extends _StringsReceiveOptionsPageEn {
	...
	@override String get appDirectory => '(FileFlow folder)';
...
class _StringsWebSharePageFr extends _StringsWebSharePageEn {
	...
	@override String get encryptionHint => 'FileFlow utilise un certificat auto-signé. Vous devez l\'accepter dans le navigateur.';
...
class _StringsAboutPageFr extends _StringsAboutPageEn {
	...
	// Translations
	@override String get title => 'A propos de FileFlow';
	@override List<String> get description => [
		'FileFlow est un logiciel gratuit et open-source qui vous permet de partager de manière sécurisée des fichers et des messages avec d\'autres appareils sur votre réseau local, sans même avoir besoin d\'une connexion à internet.',
		'FileFlow est disponible sur Android, iOS, macOS, Windows et Linux. Vous pouvez accéder à ces téléchargements sur la page officielle.',
	];
...
class _StringsDonationPageFr extends _StringsDonationPageEn {
	...
	@override String get info => 'FileFlow est gratuit, open-source and sans aucune pub. Si vous aimez ce logiciel, vous pouvez faire un don pour supporter son développement.';
...
class _StringsTrayFr extends _StringsTrayEn {
	...
	@override String get close => 'Quitter FileFlow';
...
class _StringsSettingsTabGeneralFr extends _StringsSettingsTabGeneralEn {
	...
	@override String get showInContextMenu => 'Montrer FileFlow dans le menu contextuel';
...
class _StringsSettingsTabOtherFr extends _StringsSettingsTabOtherEn {
	...
	@override String get support => 'Supporter FileFlow';
...
class _StringsDialogsLocalNetworkUnauthorizedFr extends _StringsDialogsLocalNetworkUnauthorizedEn {
	...
	@override String get description => 'FileFlow ne peut pas trouver d\'autres appareils sans la permission de scanner votre réseau local. Veuillez autoriser cette permission à FileFlow dans les paramètres.';
...
class _StringsDialogsSendModeHelpFr extends _StringsDialogsSendModeHelpEn {
	...
	@override String get link => 'Les récipients n\'ayant pas FileFlow installé peuvent télécharger les fichiers sélectionnés en ouvrant le lien dans leur navigateur.';
}
