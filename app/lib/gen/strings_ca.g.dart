...
class _StringsReceiveOptionsPageCa extends _StringsReceiveOptionsPageEn {
	...
	@override String get appDirectory => '(Carpeta FileFlow)';
...
class _StringsWebSharePageCa extends _StringsWebSharePageEn {
	...
	@override String get encryptionHint => 'FileFlow utilitza un certificat auto-signat. Cal que l\'accepteu al navegador.';
...
class _StringsTrayCa extends _StringsTrayEn {
	...
	@override String get close => 'Sortir de FileFlow';
}
...
class _StringsDialogsLocalNetworkUnauthorizedCa extends _StringsDialogsLocalNetworkUnauthorizedEn {
	...
	@override String get description => 'FileFlow no pot trobar altres dispositius sense tenir el permís per escanejar la xarxa local. Concediu aquest permís a la configuració.';
...
class _StringsDialogsSendModeHelpCa extends _StringsDialogsSendModeHelpEn {
	...
	@override String get link => 'Els destinataris que no tinguin FileFlow instal·lat poden descarregar els fitxers seleccionats obrint l\'enllaç al seu navegador.';
}
