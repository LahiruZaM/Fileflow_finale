...
class _StringsReceiveOptionsPageDe extends _StringsReceiveOptionsPageEn {
	...
	@override String get appDirectory => '(FileFlow-Ordner)';
...
class _StringsWebSharePageDe extends _StringsWebSharePageEn {
	...
	@override String get encryptionHint => 'FileFlow verwendet ein selbstsigniertes Zertifikat. Sie müssen es im Browser akzeptieren.';
...
class _StringsAboutPageDe extends _StringsAboutPageEn {
	...
	// Translations
	@override String get title => 'Über FileFlow';
...
class _StringsDonationPageDe extends _StringsDonationPageEn {
	...
	@override String get info => 'FileFlow ist kostenlos, open-source und frei von Werbung. Wenn dir diese App gefällt, kannst du die Entwicklung mit einer Spende unterstützen.';
...
class _StringsTrayDe extends _StringsTrayEn {
	...
	@override String get close => 'FileFlow beenden';
...
class _StringsSettingsTabGeneralDe extends _StringsSettingsTabGeneralEn {
	...
	@override String get showInContextMenu => 'FileFlow im Kontextmenü anzeigen';
...
class _StringsSettingsTabOtherDe extends _StringsSettingsTabOtherEn {
	...
	@override String get support => 'FileFlow unterstützen';
...
class _StringsDialogsLocalNetworkUnauthorizedDe extends _StringsDialogsLocalNetworkUnauthorizedEn {
	...
	@override String get description => 'FileFlow kann nicht auf das lokale Netzwerk zugreifen. Bitte erlaube FileFlow den Zugriff auf das lokale Netzwerk in den Einstellungen.';
...
class _StringsDialogsSendModeHelpDe extends _StringsDialogsSendModeHelpEn {
	...
	@override String get link => 'Empfänger, die FileFlow nicht installiert haben, können die ausgewählten Dateien herunterladen, in dem sie den Link im Browser öffnen.';
}
