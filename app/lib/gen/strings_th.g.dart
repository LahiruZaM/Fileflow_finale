...
class _StringsReceiveOptionsPageTh extends _StringsReceiveOptionsPageEn {
	...
	@override String get appDirectory => '(โฟลเดอร์ของ FileFlow)';
...
class _StringsWebSharePageTh extends _StringsWebSharePageEn {
	...
	@override String get encryptionHint => 'FileFlow ใช้ใบรับรองอุปกรณ์จากเว็บเบราเซอร์ (self-signed certificate) คุณต้องกดยอมรับใบรับรองนี้ในเบราว์เซอร์บนอุปกรณ์ของคุณ';
...
class _StringsAboutPageTh extends _StringsAboutPageEn {
	...
	// Translations
	@override String get title => 'เกี่ยวกับ FileFlow';
...
class _StringsDonationPageTh extends _StringsDonationPageEn {
	...
	@override String get info => 'FileFlow เป็นแอปโอเพ่นซอร์สที่คุณสามารถดาวน์โหลดมาใช้ได้ฟรีโดยไม่เสียค่าใช้จ่ายหรือโฆษณาแฝง หากคุณชื่นชอบแอปนี้ คุณสามารถสนับสนุนการพัฒนาแอปได้ด้วยการบริจาคเงิน';
...
class _StringsTrayTh extends _StringsTrayEn {
	...
	@override String get close => 'ออกจากแอป FileFlow';
}
...
class _StringsSettingsTabGeneralTh extends _StringsSettingsTabGeneralEn {
	...
	@override String get showInContextMenu => 'แสดง FileFlow ในเมนูคลิกขวา';
...
class _StringsSettingsTabOtherTh extends _StringsSettingsTabOtherEn {
	...
	@override String get support => 'สนับสนุน FileFlow';
...
class _StringsDialogsLocalNetworkUnauthorizedTh extends _StringsDialogsLocalNetworkUnauthorizedEn {
	...
	@override String get description => 'FileFlow ไม่สามารถค้นหาอุปกรณ์อื่นได้หากคุณไม่ให้สิทธิ์การสแกนเครือข่ายที่อุปกรณ์นี้กำลังเชื่อมต่ออยู่ โปรดอนุญาตให้สิทธิ์ในการสแกนนี้ในหน้าการตั้งค่า';
...
class _StringsDialogsSendModeHelpTh extends _StringsDialogsSendModeHelpEn {
	...
	@override String get link => 'ผู้รับที่ไม่ได้ติดตั้งแอป FileFlow สามารถดาวน์โหลดไฟล์ที่เลือกไว้ในรายการได้โดยการเปิดลิงก์ในเบราว์เซอร์';
}
