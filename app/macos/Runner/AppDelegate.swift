...
class AppDelegate: FlutterAppDelegate {
    ...
    override func applicationDidFinishLaunching(_ notification: Notification) {
        ...
        let fileflowBrandColor = NSColor(red: 0, green: 0.392, blue: 0.353, alpha: 0.8) // #00645a
        DockProgress.style = .squircle(color: fileflowBrandColor)
        
        isLaunchedAsLoginItem = LaunchAtLogin.wasLaunchedAtLogin
    }
    
    override func applicationShouldHandleReopen(_ sender: NSApplication, hasVisibleWindows flag: Bool) -> Bool {
        showFileFlowFromMenuBar()
        return false
    }
    ...
    private func setupStatusBarItem(i18n: [String: String]) {
        ...
        if let button = statusItem?.button {
            ...
            let openItem = NSMenuItem(title: openString, action: #selector(showFileFlowFromMenuBar), keyEquivalent: "o")
    ...
    @objc func showFileFlowFromMenuBar() {
        channel?.invokeMethod("showFileFlowFromMenuBar", arguments: nil)
    }
